    ...
    <body style="background: radial-gradient(#614385,#516395);">
                ...
                <div class="lab" id="addgame" style="margin:auto">
                    ...
                    <form name="form1" action="" method="post" enctype="multipart/form-data">
                        <table class="tcenter">
                            ...
                            <tr>
                                <td>Description</td>
                                <td class="smallB"><span class="inp" style="color:black;" id="Gprice" name="Gprice"><?php echo $game_description;?></span></td>
                            </tr>
                            <tr>
                                <td>Quantity</td>
                            ...
                            <tr>
                                <td colspan="2" align="center" ><input class="btn" type="submit" name="submit1" id="submit1"value="ADD"></td>
                            </tr>
                        </table>
                    </form>
                </div>
        ...
        <?php
            if(isset($_POST['submit1'])){
                ...
                mysqli_query($link,"INSERT INTO cart VALUES('', $userid, $id, $_POST[Gquantity], $progress, $total_price)"); 
        ?>
