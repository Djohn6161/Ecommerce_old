...
$progress=1;
    $id = $_GET["id"];
    $q = "select * from cart, games, users where cart.games_id = games.id and cart.user_id = users.id and cart_id=$id";
    ...
    <body style="background: radial-gradient(#614385,#516395);">
                ...
                <div class="lab" id="addgame" style="margin:auto">
                    ...
                    <form name="form1" action="" method="post" enctype="multipart/form-data">
                        <table class="tcenter">
                            ...
                            <tr>
                                <td>Username</td>
                                <td class="smallB"><span class="inp" style="color:black;" id="Gname" name="Gname"><?php echo $username;?></td>
                            </tr>
                            <tr>
                                <td>Quantity</td>
                                <td><input  class="inp" style="color:black;" type="number" id="Gquantity" name="Gquantity" value="<?php echo $quantity;?>"></td>
                            </tr>
                            <tr>
                                <td>Game Total Price</td>
                                <td class="smallB"><input class="inp" style="color:black;" type="text" id="GTprice" name="GTprice" value="<?php echo $game_price;?>" ></td>
                            </tr>
                            <tr>
                                <td>Progress</td>
                                <td>
                                    <select class="form-control" style="color:black;" id="Progress" name="Progress">
                                        <option value="" selected disabled>Select Progress</option>
                                        <option value="1">Complete</option>
                                        <option value="0">In Progress</option>
                                    </select>
                                </td>
                                <!--<td class="smallB"><input class="inp" style="color:black;" type="text" id="Progress" name="Progress" value="<?php echo $quantity;?>" ></td>
                --></tr>
                            <tr>
        ...
        <?php
            if(isset($_POST['submit1'])){
                mysqli_query($link,"update cart set progress='$_POST[Progress]', quantity='$_POST[Gquantity]' where cart_id=$id"); 
        ?>
